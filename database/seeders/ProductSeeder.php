...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $products = [
            ...
            ["name" => "Parmeggiano", "category" => "1", "price" => 35, "weight" => 100, "description" => "Hård och salt ost med mycket smak", "image_url" => "https://cdb.arla.com/api/assets/falbygdensost/3a0a1a7a-bd91-4013-b834-bc23c860f72f/parmeggiano-webb.jpg?mode=crop&transform=downfill&quality=80&width=666&height=444"],
            ["name" => "Brillat Savarin", "category" => "6", "price" => 22, "weight" => 120, "description" => "Mild och krämig vitmögelost med syrad grädde", "image_url" => "https://images.arla.com/recordid/985AE336-0AE6-41EA-B84FD1420E95AE90/brillat-savarin-med-balsamicostekt-vattenmelon-och-jordgubbssalsa.jpg?mode=crop&transform=downfill&quality=80&width=666&height=444"],
            ...
            ["name" => "Engelsk Cheddar", "category" => "1", "price" => 16, "weight" => 130, "description" => "Kraftig och nötig smak, lagrad.", "image_url" => "https://cdb.arla.com/api/assets/falbygdensost/efd31ae7-0bcd-4c07-8a18-540816e6ec1a/cheddar.jpg?mode=crop&transform=downfill&quality=80&width=364&height=252"],
            ...
            ["name" => "vacherousse d'argental", "category" => "5", "price" => 14, "weight" => 120, "description" => "Krämig, sötaktig och fyllig färskost.", "image_url" => "https://cheeseculture.com.au/cdn/shop/files/vacherousse.jpg?v=1697000919"],
            ["name" => "Burrata", "category" => "3", "price" => 13, "weight" => 90, "description" => "Mild, elastisk och krämig ost.", "image_url" => "https://images.squarespace-cdn.com/content/v1/602179b785961727c6f7fe3f/1657966016932-26SZNRYY3MGMTPEZJNYO/_DSC5060.jpeg"],
            ["name" => "Chèvre", "category" => "4", "price" => 18, "weight" => 100, "description" => "Mild och syrlig med krämig konsistens.", "image_url" => "https://cdb.arla.com/api/assets/falbygdensost/78a41f00-c379-450f-8997-fbe0716ca172/chevre.jpg?mode=crop&transform=downfill&quality=80&width=666&height=444"],
            ["name" => "Munster", "category" => "5", "price" => 23, "weight" => 120, "description" => "Stark doft och kraftfull smak.", "image_url" => "https://cdb.arla.com/api/assets/falbygdensost/2a2c9d83-3728-42f4-a9a0-8335d25df1a3/munster.jpg?mode=crop&transform=downfill&quality=80&width=666&height=444"],
            ["name" => "Brie de Meaux", "category" => "6", "price" => 18, "weight" => 180, "description" => "Krämig och mild med nötig eftersmak.", "image_url" => "https://cdb.arla.com/api/assets/falbygdensost/70e0a3ef-ba0d-4091-845b-fd089dc338b9/brie-webb-1.jpg?mode=crop&transform=downfill&quality=80&width=340&height=340"],
