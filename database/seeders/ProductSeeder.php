...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $products = [
            ...
            ["name" => "Brie de Meaux", "category" => "6", "price" => 18, "weight" => 180, "description" => "Krämig och mild med nötig eftersmak.", "image_url" => "https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Brie_01.jpg/800px-Brie_01.jpg"],
